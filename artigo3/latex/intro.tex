...
\item[2.] Um elétron só pode se mover em uma órbita na qual seu momento angular orbital é 
$L = n\hbar$, $n \in \mathbb N$, sendo $\hbar$ a constante de Planck dividida por $2\pi$.
...
\item[4.] Se um elétron que se move inicialmenle sobre uma órbita de energia total $E_i$ 
passa a se mover em uma de energía total $E_f < E_i$, é emitida radiação eletromagnética
de frequência $\nu = (E_i - E_f)/h$.
\end{itemize}
