...
O valor médio encontrado para $\lambda$ foi $\langle \lambda \rangle = 633 \pm 26  \text{ nm} $, o que equivale a um desvio de 0,03$\%$ do valor informado pelo fabricante, de 632,8 nm. 
...
Os dados obtidos são mostrados na tabela \ref{tab: exp2}. Utilizando o programa xmgrace para fazer uma regressão linear, mostrada na Fig. \ref{fig: regression}, foi encontrado o coeficiente linear $0,035479$ mbar$^{-1}$. Utilizando esse resultado na eq. \eqref{eq: kappa}, obtemos
...
\includegraphics[width=0.7\columnwidth]{imagens/regression.eps}
\small{\textit{\\Fonte: autor, 2026.}}
