...
O aparato experimental foi montado conforme o esquema na figura \ref{fig: interferometer} e o laser foi alinhado. 
...
O outro espelho, $M_2$, possui parafusos de regulagem, que foram usados para centralizar o padrão de interferência no anteparo \cite{roteiro}. 

\begin{table}[h]\label{tab: materials}
\centering
\begin{tabular}{lc}
\toprule
...
De acordo com \citep{andrews1960optics}, para pequenas variações de $\theta$ em torno de $0^{\circ}$, $n=n(\theta, m)$ é dado por 
\begin{equation}
