...
\noindent onde $A$ é a amplitude (real) de $E$. 
Fazendo $v_j  = |v_j|e^{i\phi_j}$, a eq. \eqref{eq: resulting intensity} se torna
...
\noindent A radiação eletromagnética proveniente de um laser pode ser modelada como uma onda plana monocromática que se propaga em uma dimensão.
Temos então
\begin{equation}
...
\frac{2\pi \Lambda}{\lambda_0} = 2m\pi \implies \lambda_0 = \frac{\Lambda}{m}.
\end{equation}
