...
Antecipando o resultado de que a carga em cada bolha será um multiplo inteiro de um valor fundamental $e=\qty{1,602e-19}{\coulomb}$ \citep{millikan}, a carga medida é dada em unidades dessa constante $e$.
...
Esse grande desvio se dá principalmente pela forma como o experimento é formulado. 
Com o aparato atual, apenas é possível medir o movimento das gotas em uma dimensão, 
quando, na realidade, elas possuem 3 graus de liberdade.

Mesmo com esses desvios, 
é possível ver na Fig. \ref{fig: carga_vs_raio} que os pontos tendem a se agrupar em torno de múltiplos inteiros de $e$, 
indicados pelas linhas horizontais tracejadas. 
Embora haja muitos pontos vermelhos, nota-se que a medida que os valores de $q$ aumentam, 
a razão entre pontos vermelhos e pretos diminui. 
...
Na Fig. \ref{fig: carga_vs_n}, é mostrada a relação entre $q$ e $n$. Realizando uma regressão linear, foi obtido o coeficiente angular $\num{1,658}$, o que implica em $e = \qty{1,658e-19}{\coulomb}$.
