...
Os materiais utilizados são mostrados na tabela \ref{tab: materiais}.
...
Utilizando os dados da tabela \ref{tab: grandezas}, foi possível calcular os valores da constantes $A$ que aparece nas eq. \eqref{eq: r} como sendo $A = \qty{6,406e-5}{\meter\tothe{1/2}\second\tothe{1/2}}$.
