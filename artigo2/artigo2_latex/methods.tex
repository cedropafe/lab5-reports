...
Esse espaço é fechado para o ambiente externo, e é iluminado por uma lâmpada própria do aparato.
...
inverter a polaridade no capacitor, e asism inverter o sentido do campo elétrico.
Em paralelo, foi conectado um voltímetro. 

Primeiramente, era borrifado as gotas de óleo de silicone utilizando a pera insufladora. 
...
Utilizando então as eqs. \eqref{eq: r} e \eqref{eq: q'}, foi possível obter os valores de $q$ e $r$ para cada gota.  
...
Utilizando os dados da tabela \ref{tab: valores}, foi possível calcular os valores das constantes que aparecem nas eqs. \eqref{eq: r} e \eqref{eq: q'} como sendo $A = \qty{6,406e-5}{\meter\tothe{1/2}\second\tothe{1/2}}$, e $B = \qty{2.732e-11}{\kilo\gram\meter\tothe{1/2}\second\tothe{-1/2}}$.
...
Densidade do óleo de silicone & $\rho_1=\qty{1,03e3}{\kilo\gram\per\meter\tothe 3}$ \\
Densidade do ar & $\rho_2=\qty{1,293}{\kilo\gram\per\meter\tothe3}$ \\
