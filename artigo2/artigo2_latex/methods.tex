...
Utilizando os dados da Tab. \ref{tab: grandezas}, foi possível calcular os valor da constante $A$ que aparece nas eqs. \eqref{eq: r} e \eqref{eq: q'} como sendo $A = \qty{6,406e-5}{\meter\tothe{1/2}\second\tothe{1/2}}$.
